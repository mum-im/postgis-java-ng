...
public class DriverWrapper extends Driver
{
		...
		try
		{
			...
			if (clazzC3P0ProxyConnection.isInstance(conn))
			{
				...
				mrawConnectionOperation.invoke(conn, mAddDataType, null,
						new Object[] { "geometry", de.mum.postgis.PGgeometry.class });
				mrawConnectionOperation.invoke(conn, mAddDataType, null,
						new Object[] { "geography", de.mum.postgis.PGgeography.class });
				mrawConnectionOperation.invoke(conn, mAddDataType, null,
						new Object[] { "box2d", de.mum.postgis.PGbox2d.class });
				mrawConnectionOperation.invoke(conn, mAddDataType, null,
						new Object[] { "box3d", de.mum.postgis.PGbox3d.class });
				mrawConnectionOperation.invoke(conn, mAddDataType, null,
						new Object[] { "public.geometry", de.mum.postgis.PGgeometry.class });
				mrawConnectionOperation.invoke(conn, mAddDataType, null,
						new Object[] { "public.geography", de.mum.postgis.PGgeography.class });
				mrawConnectionOperation.invoke(conn, mAddDataType, null,
						new Object[] { "public.box2d", de.mum.postgis.PGbox2d.class });
				mrawConnectionOperation.invoke(conn, mAddDataType, null,
						new Object[] { "public.box3d", de.mum.postgis.PGbox3d.class });
				mrawConnectionOperation.invoke(conn, mAddDataType, null,
						new Object[] { "\"public\".\"geometry\"", de.mum.postgis.PGgeometry.class });
				mrawConnectionOperation.invoke(conn, mAddDataType, null,
						new Object[] { "\"public\".\"geography\"", de.mum.postgis.PGgeography.class });
	...
	{
		pgconn.addDataType("geometry", de.mum.postgis.PGgeometry.class);
		pgconn.addDataType("geography", de.mum.postgis.PGgeography.class);
		pgconn.addDataType("box2d", de.mum.postgis.PGbox2d.class);
		pgconn.addDataType("box3d", de.mum.postgis.PGbox3d.class);
		pgconn.addDataType("public.geometry", de.mum.postgis.PGgeometry.class);
		pgconn.addDataType("public.geography", de.mum.postgis.PGgeography.class);
		pgconn.addDataType("public.box2d", de.mum.postgis.PGbox2d.class);
		pgconn.addDataType("public.box3d", de.mum.postgis.PGbox3d.class);
		pgconn.addDataType("\"public\".\"geometry\"", de.mum.postgis.PGgeometry.class);
		pgconn.addDataType("\"public\".\"geography\"", de.mum.postgis.PGgeography.class);
		pgconn.addDataType("\"public\".\"box2d\"", de.mum.postgis.PGbox2d.class);
		pgconn.addDataType("\"public\".\"box3d\"", de.mum.postgis.PGbox3d.class);
